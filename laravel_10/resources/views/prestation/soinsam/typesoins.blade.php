...
<div class="app-body">
    @include('pageTitre', [
        'title' => 'TYPE DE SOINS',
        'subtitle' => 'Configurations / Infirmerie / Type de Soins'
    ])
    <div class="row gx-3" >
        <div class="col-sm-12">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function eng() 
        {
            ...
            $.ajax({
                url: $('#url').attr('content') +'/api/new_typesoins',
                method: 'GET',
                data: { nom: nom.value,},
        ...
        function list() {
            ...
            fetch($('#url').attr('content') +'/api/list_typesoins') // API endpoint
        ...
        function updatee() {
            ...
            $.ajax({
                url: $('#url').attr('content') +'/api/update_typesoins/'+id,
        ...
        function deletee() {
            ...
            $.ajax({
                url: $('#url').attr('content') +'/api/delete_typesoins/'+id,
                method: 'GET',
                success: function(response) {
                    var preloader = document.getElementById('preloader_ch');
                    if (preloader) {
